...
<body class="bg-[linear-gradient(117deg,rgba(255,255,255,1)_0%,rgba(247,249,248,1)_40%,rgba(232,245,238,1)_100%)] flex flex-col items-center pt-8 pb-12 font-sans select-none overflow-x-hidden">

    <div id="step-1" class="w-full flex flex-col items-center" style="display: flex;">
...
                            {{ $service->name }}
                        </h2>
                        <p class="font-medium text-[#5f6b66] text-[15px] line-clamp-2 leading-relaxed">
